...
class LegacyValidatingNotifier(object):
    ...
    allowed_legacy_notification_event_types = [
        ...
        'compute.instance.change_password.start',
        'compute.instance.change_password.end',
        'compute.instance.change_password.error',
        ...
        'compute.instance.interface_detach.error',
        ...
        'compute.instance.revert_to_snapshot.start',
        'compute.instance.revert_to_snapshot.end',
        'compute.instance.revert_to_snapshot.error',
